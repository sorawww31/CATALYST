...
def record_results(
    ...
    save_to_table(
        args.table_path,
        f'{"_".join(args.net)}_{args.threatmodel}{args.name}',
        args.dryrun,
        budget=args.budget,
        eps=args.eps,
        target=(
            class_names[kettle.poison_setup["target_class"]]
            if kettle.poison_setup["target_class"] is not None
            else "Several"
        ),
        ...
        wolfe_c2 = args.wolfe[0],
        wolfe_c1 = args.wolfe[1],
